...
/// <summary>
/// Response model for one physical, QR-tracked inventory item.
/// </summary>
public record InventoryItemResult
{
    /// <summary>Gets the unique inventory item identifier.</summary>
    ...
    /// <summary>Gets the QR payload that resolves this inventory item.</summary>
    ...
    /// <summary>Gets the timestamp when this item was received.</summary>
